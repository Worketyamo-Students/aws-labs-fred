      ...
      >
        ...
        <div className='flex flex-col justify-center w-100'>
            ...
            <div className='flex flex-col justify-center items-center gap-6'>
                ...
                <div className='flex gap-1 border-2 w-full justify-center h-10 items-center rounded-md border-gray-300'>
       ...
       <div className='flex items-centerh-20 justify-center m-4 p-3 gap-2 w-100'>
