...
const OtpPage = () => {
  ...
  return (
    <div className='flex justify-center mt-10 w-full mb-20'>
                    ...
                    <div className='flex flex-col'>
                       ...
                       <div>
                            <div className='flex items-center gap-3'>
                                ...
                                <div>
                                    <h2 className='font-semibold'>Validation OTP</h2>
                                    <p className='text-gray-400'>Entrez vos informations personnelles</p>
                                </div>
                            </div>
                            <div className='bg-gray-300 h-13 w-[2px] ml-6'></div>
        ...
        <div className="mt-20 m-9 p-6 flex items-center justify-center w-1/3">
